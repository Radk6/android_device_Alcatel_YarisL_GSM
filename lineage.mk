# Release name
PRODUCT_RELEASE_NAME := YARIS35_GSM

# Inherit some common CM stuff.
$(call inherit-product, vendor/cm/config/common_full_phone.mk)

# Inherit device configuration
$(call inherit-product, device/Alcatel/YARIS35_GSM/device_YARIS35_GSM.mk)
...
PRODUCT_DEVICE := YARIS35_GSM
PRODUCT_NAME := lineage_YARIS35_GSM
